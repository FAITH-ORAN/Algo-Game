...
document.getElementById("ad").innerHTML="Bonne réponse";
count++;
victory++;
}
...
document.getElementById("ac").innerHTML="Mauvaise réponse";
count++;
...
function getAnswer_7() {
    ...
    btn5.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_18() {
    ...
    btn16.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_19() {
    ...
    btn17.innerHTML="Bonne réponse";
    count++;
    victory++;
}
function getAnswer_20() {
    btn18.style.backgroundColor="red";
    btn18.innerHTML="Mauvaise réponse";
    count++;
    victory++;
}
...
function getAnswer_36() {
    ...
    btn34.innerHTML="Bonne réponse";
    count++;
    victory++;
}
function getAnswer_37() {
    btn35.style.backgroundColor="red";
    btn35.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_40() {
    btn38.style.backgroundColor="green";
    btn38.innerHTML="Bonne réponse";
    count++;
    victory++;
}
function getAnswer_41() {
    btn39.style.backgroundColor="red";
    btn39.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_43() {
    ...
    btn41.innerHTML="Bonne réponse";
    count++;
    victory++;
}
function getAnswer_44() {
    btn42.style.backgroundColor="red";
    btn42.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_47() {
    btn45.style.backgroundColor="red";
    btn45.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_49() {
    btn47.style.backgroundColor="green";
    btn47.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_53() {
    btn51.style.backgroundColor="red";
    btn51.innerHTML="Mauvaise réponse";
    count++;
    
}
function getAnswer_54() {
    btn52.style.backgroundColor="green";
    btn52.innerHTML="Bonne réponse";
    count++;
    victory++;
}
//quiz n°15
...
function getAnswer_56() {
    btn54.style.backgroundColor="red";
    btn54.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_58() {
    btn56.style.backgroundColor="green";
    btn56.innerHTML="Bonne réponse";
    count++;
    victory++;
}
//quiz n°16
...
function getAnswer_59() {
    btn57.style.backgroundColor="green";
    btn57.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_62() {
    btn60.style.backgroundColor="red";
    btn60.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_63() {
    btn61.style.backgroundColor="red";
    btn61.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_65() {
    btn63.style.backgroundColor="green";
    btn63.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_68() {
    btn66.style.backgroundColor="red";
    btn66.innerHTML="Mauvaise réponse";
    count++;
    
}
function getAnswer_69() {
    btn67.style.backgroundColor="green";
    btn67.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_72() {
    btn70.style.backgroundColor="red";
    btn70.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_74() {
    btn72.style.backgroundColor="green";
    btn72.innerHTML="Bonne réponse";
    count++;
    victory++;
}
//quiz n°20
...
function getScore() {
    showResult.innerHTML="le pourcentage de reussite dans le niveau 2 est  : "+"<strong>"+ victory*100/count+"%"+"</strong>";

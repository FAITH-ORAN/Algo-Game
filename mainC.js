...
document.getElementById("ab").innerHTML="Bonne réponse";
count++;
victory++;
}
...
function getAnswer_3() {
    ...
    btn1.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_13() {
    ...
    btn11.innerHTML="Mauvaise réponse";
    count++;
    
}
function getAnswer_14() {
    btn12.style.backgroundColor="green";
    btn12.innerHTML="Bonne réponse";
    count++;
    victory++;
}
//quiz n°5
...
function getAnswer_23() {
    ...
    btn21.innerHTML="Mauvaise réponse";
    count++;
...
function getAnswer_30() {
    btn28.style.backgroundColor="red";
    btn28.innerHTML="Mauvaise réponse";
    count++; 
}
//quiz n°9
...
function getAnswer_33() {
    ...
    btn31.innerHTML="Mauvaise réponse";
    count++;  
}
function getAnswer_34() {
    btn32.style.backgroundColor="green";
    btn32.innerHTML="Bonne réponse";
    count++;
    victory++;
}
//quiz n°10
...
function getAnswer_39() {
    btn37.style.backgroundColor="green";
    btn37.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_55() {
    btn53.style.backgroundColor="green";
    btn53.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_59() {
    ...
    btn57.innerHTML="LMauvaise réponse";
    count++;
}
...
function getAnswer_61() {
    btn59.style.backgroundColor="green";
    btn59.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_73() {
    btn71.style.backgroundColor="green";
    btn71.innerHTML="Bonne réponse";
    count++;
    victory++;
}
...
function getAnswer_77() {
    btn75.style.backgroundColor="green";
    btn75.innerHTML="Bonne réponse";
    count++;
    victory++;
}
function getAnswer_78() {
    btn76.style.backgroundColor="red";
    btn76.innerHTML="Mauvaise réponse";
    count++;
}
...
function getScore() {
    showResult.innerHTML="le pourcentage de reussite dans le niveau 3 est  : "+"<strong>"+ victory*100/count+"%"+"</strong>";
